...
namespace MyComercio.Controllers
{
    public class ProductoController : Controller
    {
        ...
        {
            ViewBag.ListaCategorias = MyHelper.GetCategoriaList();
        ...
        public async Task<IActionResult> Create([Bind("IdCategoriaProducto,Precio,Marca,Modelo,Id,Descripcion")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategoriaProducto,Precio,Marca,Modelo,Id,Descripcion")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
